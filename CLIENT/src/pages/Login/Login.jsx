...
import "./Login.css";
import { CameraAlt, WidthFull } from "@mui/icons-material";
...
const Login = () => {
  ...
  return (
    <div style={{
      backgroundColor : "rgba(17, 149, 210, 1)",
      }}>
    <Container component="main">
      <Paper
        ...
        sx={{
          ...
          padding: 4,
          marginTop: 8,
          backgroundImage:"linear-gradient(90deg,#bde0fe,white)",
        }}>
        {isLogin ? (
          <div className="container">
            ...
            <span className="agreement" onClick={toggleLogin}>
